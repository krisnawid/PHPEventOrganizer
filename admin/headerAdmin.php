...
<nav class="navbar navbar-expand-md bg-dark navbar-dark fixed-top">
        <ul class="navbar-nav">
            <li>
                <a href="formAdmin.php" style="margin-right: 150px;font-size: 40px;text-decoration:none" class="ini-berlin">
                    OSem
                </a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu transparana ini-quicksand" aria-labelledby="dropdownMenuButton">
                        ...
                        <a class="dropdown-item" href="#">Contact Person OSem</a>
                    </div>
                </div>
            </li>
            <li class="nav-item">
            <?php if (isset($username)) { ?>
                <div class="dropdown">
                    <a class="nav-link dropdown-toggle" href="" style="margin-right: 80px;color: white" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Create Event's </a>
                    <div class="dropdown-menu transparana ini-quicksand" aria-labelledby="dropdownMenuButton">
                        <a class="dropdown-item" href="#">Make Event's</a>
                        <a class="dropdown-item" href="#">Resource</a>
                    </div>
                </div>
            <?php } else { ?>
                <a href="addEvents.php" class="nav-link" style="margin-right: 80px; color: white">Create Event's</a>
            <?php } ?>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="#skill" style="margin-right: 80px; color: white">Organize </a>
            </li>
            <li class="nav-item">
            <?php if (isset($username)) { ?>
                <div class="dropdown">
